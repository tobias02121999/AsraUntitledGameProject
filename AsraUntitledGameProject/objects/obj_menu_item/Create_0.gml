...
buttonID[0] = 9; // The event ID of the button
buttonID[1] = 4; // The event ID of the button

buttonText[0] = "Potion"; // The text displayed on the button
buttonText[1] = "Back"; // The text displayed on the button
